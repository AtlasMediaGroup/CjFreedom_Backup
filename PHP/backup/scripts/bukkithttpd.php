...
echo "Downloaded BukkitHttpd.jar To: <a href='backup/BukkitHttpd/BukkitHttpd.jar'>backups/BukkitHttpd/BukkitHttpd.jar</a>" 
?>
<br />
<?php
...
echo "Downloaded config.yml To: <a href='backup/BukkitHttpd/config.yml'>backups/BukkitHttpd/config.yml</a>" 
?>
<br />
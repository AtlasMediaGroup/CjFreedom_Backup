...
echo "Downloaded Essentials.jar To: <a href='backup/Essentials/Essentials.jar'>backups/Essentials/Essentials.jar</a>" 
?>
<br />
<?php
...
echo "Downloaded EssentialsSpawn.jar To: <a href='backup/Essentials/EssentialsSpawn.jar'>backups/Essentials/EssentialsSpawn.jar</a>" 
?>
<br />
<?php
...
echo "Downloaded config.yml To: <a href='backup/Essentials/config.yml'>Essentials/Essentials/config.yml</a>" 
?>
<br />
<?php
...
echo "Downloaded motd.txt To: <a href='backup/Essentials/motd.txt'>backups/Essentials/motd.txt</a>" 
?>
<br />
<?php
$file = ''.$address.'/plugins/Essentials/config.yml?password='.$password.'';
...
$current = file_get_contents($file);
file_put_contents("backup/Essentials/Essentials/config.yml", $current);
echo "Downloaded config.yml To: <a href='backup/Essentials/config.yml'>Essentials/config.yml</a>" 
?>
<br />
...
echo "Downloaded BukkitTelnet.jar To: <a href='backup/BukkitTelnet/BukkitTelnet.jar'>backups/BukkitTelnet/BukkitTelnet.jar</a>" 
?>
<br />
<?php
...
echo "Downloaded config.yml To: <a href='backup/BukkitTelnet/config.yml'>backups/BukkitTelnet/config.yml</a>" 
?>
<br />